...
!!! info "How AsyncClient Works"

    `AsyncClient` wraps the synchronous Rust client using `asyncio.run_in_executor()`.
    This means:
...
- [SSL/TLS](../advanced/ssl-tls.md) - Secure connections with async
- [Proxy Configuration](../advanced/proxy.md) - Use proxies with AsyncClient
- [API Reference](../api/async-client.md) - Complete AsyncClient API
